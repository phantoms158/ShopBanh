								...
								<div class="cart-item">
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount"><?php echo e($product['qty']); ?>*<span><?php if($product['item']['promotion_price']==0): ?><?php echo e(number_format($product['item']['unit_price'])); ?> <?php else: ?> <?php echo e(number_format($product['item']['promotion_price'])); ?><?php endif; ?></span></span>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="<?php echo e(route('loaisanpham',1)); ?>">Loại Sản phẩm</a>
							<ul class="sub-menu">
